									...
									<form>
										...
										<div class="col-12 col-md-6">
											<div class="form-group">
												...
												<input type="text" name="staffPhoneNo" id="staffPhoneNo" class="form-control"
											placeholder="Name" autofocus="autofocus"
											value="${staff.staffPhoneNo}" readonly>
											</div>
										</div>
										...
										<div class="col-6 d-flex justify-content-between">
											 <a class="btn btn-primary" href="StaffController?action=updateStaff&id=${staff.staffID}">Update Profile</a>
											 <a class="btn btn-danger" href="StaffController?action=delete&id=${staff.staffID}">Delete Profile</a>
										</div>	
									</form>
									<!-- /Profile Settings Form -->
