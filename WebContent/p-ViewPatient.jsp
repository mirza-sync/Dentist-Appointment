								...
								<div class="card-body">
									...
									<form>
										...
										<div class="col-12 col-md-6">
											...
											placeholder="Name" autofocus="autofocus"
											value="${Patient.patientPhoneNo}" readonly>
											</div>
										</div>
										...
										<div class="col-12 col-md-6">
											...
											placeholder="Name" autofocus="autofocus"
											value="${Patient.patientEmail}" readonly>
											</div>
										</div>
										<div class="col-6 d-flex justify-content-between">
											<a class="btn btn-primary submit-btn" href="PatientController?action=updateProfile&id=${patient.patientID}">Update Profile</a>
										</div>
									</form>
									<!-- /Profile Settings Form -->
